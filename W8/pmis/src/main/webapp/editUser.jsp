...
<body>
 ...
 <label>Username</label><input type="text" name="username" value="<%=uName%>">
 <label>Email</label><input type="text" value="<%=uEmail%>">
 <label>Role</label><input type="text" value="<%=uRoleID%>">
 <label>Change Password</label><input type="text" name="password" value="<%=password%>">
 <%
